...
async function buildInformation(sensorData) {
    ...
    if ((sensorData.batery || priority.includes("MUY ALTA") || tags.includes("critical")) && !tags.includes("planta") && !lowerCaseText.includes("desconocido")) {
        ...
        if ((tags.includes("rb") && !lowerCaseText.includes("ok") && lowerCaseText.includes("fallo")) || lowerCaseText.includes("ok")) {//Solo para radio basese y fallos
            ...
            if (lowerCaseText.includes("fallo") || lowerCaseText.includes("ok") || lowerCaseText.includes("down")) {
